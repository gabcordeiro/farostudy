      ...
      <header className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        {!creating ? (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-sm bg-action px-4 py-2 text-sm font-medium text-action-ink press hover:bg-action-deep"
          >
      ...
      {creating ? (
        ...
        >
          ...
          <button
            type="submit"
            disabled={busyCreate}
            className="rounded-sm bg-action px-4 py-2 text-sm font-medium text-action-ink press hover:bg-action-deep disabled:opacity-60"
          >
